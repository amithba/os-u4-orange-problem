...
📌 Overview
This project implements a mini Version Control System (VCS) similar to Git as part of the Operating Systems Lab. It demonstrates how files are stored, tracked, and committed using object storage, trees, and indexing.
